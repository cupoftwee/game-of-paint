...
const yurple = [
  'goldenrod', 'gold', 'moccasin', 'plum', 'violet', 'purple'
]; // .gamma(6).mode('lrgb')
...
const getColor = (cell, iterations) => {
  ...
  const colorScale = chroma
    //.bezier(['darkred', 'deeppink', 'lightyellow', 'lightgreen', 'teal'])
    .scale()
    .gamma(5)
    //.padding([0,0.2])
...
// constants
const MAX_GENERATIONS   = 5000;    // stop rendering new steps after this iteration
...
const DEFAULT_GRID_ITEM = { isAlive: false, deaths: 0, lastHue: undefined };
